...
public class DataAll {
    ...
    private ArrayList<Model> listOfCars;
    ...
    public ArrayList<Model> getListOfCars() {
        return listOfCars;
    }

    public void setListOfCars(ArrayList<Model> listOfCars) {
    ...
    public String toString() {
        return "DataAll{" +
                ...
                ", ListOfProducts='" + listOfCars + '\'' +
                ", ListOfProducts='" + listOfSellers + '\'' +
                '}';
    }
    ...
    public static DataAll scenarijA() {
        ...
        Product tretji = new Product(nov,"Buying",15000,"Worn-Out",System.currentTimeMillis(),nekje,new Seller("MB","Mike Brewer","041555111"));
        Product cetrti = new Product(nov,"Selling",300,"For Parts",System.currentTimeMillis(),drugje,new Seller("EC","Edd China", "041111222"));*/
        /*DateFormat test = new SimpleDateFormat("yyyy/MM/dd");
        Date date = new Date();
        String datum = test.format(date);*/
        prvi = da.addProductsToList("H","Honda","SiR","Civic","Amortizerji",400,System.currentTimeMillis(),"Leeds, UK",2212212,113121,"","MB","Mike Brewer","041555111");
        return da;
    }
}
